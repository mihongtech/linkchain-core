...
import (
	...
	_ "github.com/mihongtech/linkchain-core/common/util/event"
	"github.com/mihongtech/linkchain-core/common/util/log"
	"github.com/mihongtech/linkchain-core/contract"
	"github.com/mihongtech/linkchain-core/contract/vm"
	"github.com/mihongtech/linkchain-core/core/meta"
	"github.com/mihongtech/linkchain-core/helper"
...
type SignerFn func(meta.Address, *meta.Transaction) (*meta.Transaction, error)

// CallOpts is the collection of options to fine tune a contract call request.
type CallOpts struct {
	Pending bool         // Whether to operate on the pending state or the last known one
	From    meta.Address // Optional the sender address, otherwise the first account is used
...
type TransactOpts struct {
	From     meta.Address // Ethereum account to send the transaction from
...
type BoundContract struct {
	address    meta.Address       // Deployment address of the contract on the Ethereum blockchain
...
func NewBoundContract(address meta.Address, abi abi.ABI, caller ContractCaller, transactor ContractTransactor, filterer ContractFilterer) *BoundContract {
...
func DeployContract(opts *TransactOpts, abi abi.ABI, bytecode []byte, backend ContractBackend, params ...interface{}) (meta.Address, *meta.Transaction, *BoundContract, error) {
	// Otherwise try to deploy the contract
	c := NewBoundContract(meta.Address{}, abi, backend, backend, backend)
...
func (c *BoundContract) transact(opts *TransactOpts, address *meta.Address, input []byte) (*meta.Transaction, error) {
	var err error
