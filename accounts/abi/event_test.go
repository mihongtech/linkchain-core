...
func TestEventTupleUnpack(t *testing.T) {
	...
	var testCases = []struct {
		...
		pledgeData1,
		&[]interface{}{&meta.Address{}, &bigint, &[3]byte{}},
		&[]interface{}{
			&addr,
			&bigintExpected2,
			&[3]byte{'u', 's', 'd'}},
		...
		pledgeData1,
		&[3]interface{}{&meta.Address{}, &bigint, &[3]byte{}},
		&[3]interface{}{
			&addr,
			&bigintExpected2,
			&[3]byte{'u', 's', 'd'}},
		...
		&[]interface{}{},
		jsonEventPledge,
		"abi: cannot unmarshal meta.Address in to int",
		...
		&BadEventPledge{},
		jsonEventPledge,
		"abi: cannot unmarshal meta.Address in to string",
		"Can not unpack Pledge event into struct with wrong filed types",
	}, {
		pledgeData1,
		&[]interface{}{meta.Address{}, new(big.Int)},
		&[]interface{}{},
		jsonEventPledge,
