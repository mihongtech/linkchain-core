...
import (
	...
	"github.com/mihongtech/linkchain-core/accounts/abi/publish_tests/test"
	"github.com/mihongtech/linkchain-core/client/lcclient"
	"github.com/mihongtech/linkchain-core/common/btcec"
	_ "github.com/mihongtech/linkchain-core/common/math"
...
func DeployContracts(auth *bind.TransactOpts, conn *lcclient.Client, initialSupply *big.Int) (meta.Address, error) {
	...
	if err != nil {
		...
		return meta.Address{}, errors.New("Create contract wait timeout")
	}
	if bytes.Compare(address.CloneBytes(), addressAfterMined.CloneBytes()) != 0 {
		...
		return meta.Address{}, errors.New("Mind address error")
	}
	return address, nil
}
