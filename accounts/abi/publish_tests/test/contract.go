...
import (
	...
	"github.com/mihongtech/linkchain-core/accounts/abi"
	"github.com/mihongtech/linkchain-core/accounts/abi/bind"
...
func DeployMyToken(auth *bind.TransactOpts, backend bind.ContractBackend, initialSupply *big.Int) (meta.Address, *meta.Transaction, *MyToken, error) {
	parsed, err := abi.JSON(strings.NewReader(MyTokenABI))
	if err != nil {
		return meta.Address{}, nil, nil, err
	}
...
func NewMyToken(address meta.Address, backend bind.ContractBackend) (*MyToken, error) {
...
func NewMyTokenCaller(address meta.Address, caller bind.ContractCaller) (*MyTokenCaller, error) {
...
func NewMyTokenTransactor(address meta.Address, transactor bind.ContractTransactor) (*MyTokenTransactor, error) {
...
func NewMyTokenFilterer(address meta.Address, filterer bind.ContractFilterer) (*MyTokenFilterer, error) {
...
func bindMyToken(address meta.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(MyTokenABI))
	if err != nil {
		return nil, err
	}
...
func (_MyToken *MyTokenCaller) BalanceOf(opts *bind.CallOpts, arg0 meta.Address) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
...
//
// Solidity: function balanceOf( address) constant returns(uint256)
func (_MyToken *MyTokenSession) BalanceOf(arg0 meta.Address) (*big.Int, error) {
...
//
// Solidity: function balanceOf( address) constant returns(uint256)
func (_MyToken *MyTokenCallerSession) BalanceOf(arg0 meta.Address) (*big.Int, error) {
	return _MyToken.Contract.BalanceOf(&_MyToken.CallOpts, arg0)
}
...
func (_MyToken *MyTokenTransactor) Transfer(opts *bind.TransactOpts, _to meta.Address, _value *big.Int) (*meta.Transaction, error) {
...
//
// Solidity: function transfer(_to address, _value uint256) returns()
func (_MyToken *MyTokenSession) Transfer(_to meta.Address, _value *big.Int) (*meta.Transaction, error) {
...
//
// Solidity: function transfer(_to address, _value uint256) returns()
func (_MyToken *MyTokenTransactorSession) Transfer(_to meta.Address, _value *big.Int) (*meta.Transaction, error) {
	return _MyToken.Contract.Transfer(&_MyToken.TransactOpts, _to, _value)
}
